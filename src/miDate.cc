...
miutil::miDate::weekday(const std::string& l) const
{
  ...
  static const char* nameNO[]={ "S�ndag",
			     "Mandag",
			     "Tirsdag",
			     "Onsdag",
			     "Torsdag",
  ...
  static const char* nameNN[]={ "S�ndag",
			     "M�ndag",
			     "Tysdag",
			     "Onsdag",
			     "Torsdag",
  ...
  static const char* nameSE[]={ "S�ndag",
			     "M�ndag",
			     "Tisdag",
			     "Onsdag",
			     "Torsdag",
